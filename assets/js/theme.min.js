...
// Fonction pour descendre automatiquement lors du chargement de la page selon la largeur de l'écran
window.addEventListener('DOMContentLoaded', function() {
    if (window.innerWidth >= 300 && window.innerWidth <= 600) { 
        // Écrans entre 300px et 600px
        window.scrollTo({
            top: 800, 
            behavior: 'smooth'
        });
    } else if (window.innerWidth >= 601 && window.innerWidth <= 800) { 
        // Écrans entre 601px et 800px
        window.scrollTo({
            top: 750, 
            behavior: 'smooth'
        });
    } else if (window.innerWidth >= 801 && window.innerWidth <= 1000) { 
        // Écrans entre 801px et 1000px
        window.scrollTo({
            top: 850, 
            behavior: 'smooth'
        });
