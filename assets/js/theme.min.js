...
function ace_progress_chart(e, t, o, r) {
    new ProgressBar.Circle(e, {
        color: "#3d77a0", /**Couleur de la barre de progression ronde */
        strokeWidth: 5,
        trailWidth: 0,
        text: {
            value: t,
...
function ace_progress_line(e, t, o, r) {
    new ProgressBar.Line(e, {
        ...
        easing: "easeInOut",
        duration: r,
        color: "#3d77a0", /**Couleur de la barre de progression plate */
...
function ace_appear_elems(e, t) {
    ace_is_elems_in_viewport(e, t), $(window).scroll(function() {
...
function initialiseGoogleMap() {
    var e, t = 44.5403,
        ...
        r = $("#map"),
        i = r.get(0);
    r.data("latitude") && (t = r.data("latitude")), r.data("longitude") && (o = r.data("longitude"));
    var a = {
        zoom: 14,
        center: e = new google.maps.LatLng(t, o),
        scrollwheel: !0,
    ...
    r = new google.maps.Map(i, a), google.maps.event.addDomListener(window, "resize", function() {
        r.setCenter(e)
    })
}
certy.initGlobalVars = function() {
        this.vars.html = $("html"), this.vars.body = $("body"), this.vars.footer = $("#crt-footer"), this.vars.windowW = $(window).width(), this.vars.windowH = $(window).height(), this.vars.windowScrollTop = $(window).scrollTop(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (this.vars.mobile = !0, this.vars.html.addClass("mobile")) : (this.vars.mobile = !1, this.vars.html.addClass("desktop"))
        ...
        }), certy.nav.arrow && ($("#crt-nav-tools").removeClass("hidden"), $("#crt-nav-arrow").on("click", function() {
        ...
        this.sticky.active && !certy.vars.mobile && Modernizr.mq("(min-width: " + certy.vars.screenMd + ")") && (this.exists ? certy.vars.windowScrollTop > this.wrap.offset().top ? this.el.css({
            ...
            bottom: "auto",
            position: "relative"
        }) : (this.el = $("#crt-nav-inner"), this.wrap = $("#crt-nav-wrap"), this.el.length > 0 && this.wrap.length > 0 && (this.exists = !0)))
    }, certy.nav.tooltip.timer = 0, certy.nav.tooltip.el = "", certy.nav.tooltip.show = function(e) {
        ...
        this.sticky.active && !certy.vars.mobile && Modernizr.mq("(min-width: " + certy.vars.screenMd + ")") && (this.exists ? certy.vars.windowScrollTop > this.wrap.offset().top ? this.el.css({
            ...
            bottom: "auto",
            position: "relative"
        }) : (this.el = $("#crt-side-box"), this.wrap = $("#crt-side-box-wrap"), this.el.length > 0 && this.wrap.length > 0 && (this.exists = !0)))
    }, certy.slider = function(e) {
        for (var t = 0; t < e.length; t++) "none" != $(e[t]).data("init") && $(e[t]).slick()
    }, certy.carousel = function(e) {
        for (var t = 0; t < e.length; t++) "none" !== $(e[t]).data("init") && $(e[t]).slick({
            dots: !0
        })
    }, certy.portfolio = {}, certy.portfolio.initGrid = function(e) {
        var t = e.isotope({
        ...
        if (o.length > 0) {
            var r = o.find("button");
            $(".pf-filter button:first-child").addClass("active"), r.on("click", function() {
                r.removeClass("active"), $(this).addClass("active");
    ...
    }, certy.portfolio.closePopup = function(e) {
    ...
    function(e) {
        "use strict";
        e(function() {
            certy.initGlobalVars(), certy.vars.html.hasClass("crt-nav-on") && (Modernizr.mq("(min-width: " + certy.vars.screenMd + ")") && "auto" !== certy.nav.height && certy.nav.initScroll(e("#crt-nav-scroll")), certy.nav.makeSticky(), certy.nav.tooltip.active && e("#crt-nav a").hover(function() {
            ...
            var t = e(".pf-grid");
            t.length > 0 && (certy.portfolio.initGrid(t), e(document).on("click", ".pf-project", function() {
                var t = e(this).attr("href");
                return certy.portfolio.openPopup(e(t)), !1
            }), e(document).on("touchstart click", ".cr-portfolio-opened #pf-popup-wrap", function(t) {
                var o = e("#pf-popup-content");
                o.is(t.target) || 0 !== o.has(t.target).length || certy.portfolio.closePopup()
            })), certy.slider(e(".cr-slider")), certy.carousel(e(".cr-carousel")), console.log(certy)
...
$(function() {
    if (ace.html = $("html"), ace.body = $("body"), ace_detect_device_type(), $("#crt-main-nav-sm .has-sub-menu > a").on("click touchstart", function() {
            return !!$(this).hasClass("hover") || ($(this).addClass("hover"), $(this).next().slideDown(500), !1)
        }), ace.sidebar.obj = $("#crt-sidebar"), ace.sidebar.btn = $("#crt-sidebar-btn"), ace.sidebar.btn.on("touchstart click", function() {
            ace_open_sidebar()
        ...
        for (var e = 0; e < ace.progress.charts.length; e++) {
            var t = $(ace.progress.charts[e]);
            ace_progress_chart(t[0], t.data("text"), t.data("value"), 1)
        }
        ace.progress.lines = $(".progress-line .progress-bar");
        for (e = 0; e < ace.progress.lines.length; e++) {
            var o = $(ace.progress.lines[e]);
            ace_progress_line(o[0], o.data("text"), o.data("value"), 1)
        }
    }
    certy.progress.animation && !ace.mobile && ace_appear_elems($(".crt-animate"), 150), $("pre").each(function(e, t) {
        ...
        dots: !0
    }), $("#map").length > 0 && initialiseGoogleMap();
    var r = $(".tabs-menu>li.active");
    if (r.length > 0)
        for (e = 0; e < r.length; e++) {
            var i = $(r[e]).children().attr("href");
            $(i).addClass("active").show()
        }
    $(".tabs-menu a").on("click", function(e) {
        var t = $(this),
            o = t.attr("href"),
            r = t.closest(".tabs").find(".tab-content");
        t.parent().addClass("active"), t.parent().siblings().removeClass("active"), r.not(o).removeClass("active").hide(), $(o).addClass("active").fadeIn(500), e.preventDefault()
    });
    var a = $(".togglebox>li.active");
    a.length > 0 && a.find(".togglebox-content").show(), $(".togglebox-header").on("click", function() {
        var e = $(this);
        e.next(".togglebox-content").slideToggle(300), e.parent().toggleClass("active")
    });
    var s = $(".accordion>li.active");
    s.length > 0 && s.find(".accordion-content").show(), $(".accordion-header").on("click", function() {
        var e = $(this),
            t = e.parent(),
            o = e.next(),
            r = e.closest(".accordion").find(".accordion-content");
        t.hasClass("active") ? (t.removeClass("active"), o.slideUp()) : (t.siblings().removeClass("active"), t.addClass("active"), r.slideUp(300), o.slideDown(300))
    }), $(".comment-replys-link").on("click", function() {
        return $(this).closest(".comment").toggleClass("show-replies"), !1
    });
    var l = {
        wrapper: null,
        content: null,
        slider: null,
        open: function(e) {
            this.wrapper = $('<div id="pf-popup-wrap" class="pf-popup-wrap"><div class="pf-popup-inner"><div class="pf-popup-middle"><div class="pf-popup-container"><button id="pf-popup-close"><i class="rsicon rsicon-close"></i></button><div id="pf-popup-content" class="pf-popup-content"></div></div></div></div>'), ace.body.append(this.wrapper), this.content = $("#pf-popup-content"), this.content.append(e.clone()), l.wrapper.addClass("opened"), ace_lock_scroll()
        },
        close: function() {
            this.wrapper.removeClass("opened"), setTimeout(function() {
                l.wrapper.remove(), ace_unlock_scroll()
            }, 500)
        }
    };
    $(document).on("click", ".pf-btn-view", function() {
        var e = $(this).attr("href");
        return l.open($(e)), ace.html.addClass("crt-portfolio-opened"), !1
    }), $(document).on("touchstart click", ".crt-portfolio-opened #pf-popup-wrap", function(e) {
        var t = $("#pf-popup-content");
        t.is(e.target) || 0 !== t.has(e.target).length || (l.close(), ace.html.removeClass("crt-portfolio-opened"))
    }), $(".toggle-link").on("click", function() {
        var e = $(this).attr("href");
        return $(this).hasClass("opened") ? ($(e).slideUp(500), $(this).removeClass("opened")) : ($(e).slideDown(500), $(this).addClass("opened")), !1
    }), $("#btn-share").on("mouseenter", function() {
        $(this).parent().addClass("hovered")
    }), $(".crt-share-box").on("mouseleave", function() {
        var e = $(this);
        e.hasClass("hovered") && (e.addClass("closing"), setTimeout(function() {
            e.removeClass("hovered"), e.removeClass("closing")
        }, 300))
    })
}), $(function() {
    $(".crtFormSubmit").on("click", function(e) {
        var t, o = $(this).closest(".contact-form"),
            r = !1,
            i = o.attr("action"),
            a = o.find(".form-group"),
            s = o.find("[name='crtName']"),
            l = o.find("[name='crtEmail']"),
            c = o.find("[name='crtMessage']"),
            n = (o.find(".crtFormResponce"), o.find("[name='crtPivacyPolicy']"));
        return a.removeClass("error"), r = !1, s.val() || (r = !0, s.parent().addClass("error")), n.prop("checked") || (r = !0, n.parent().addClass("error")), l.val() && (t = l.val(), /^([a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+(\.[a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)*|"((([ \t]*\r\n)?[ \t]+)?([\x01-\x08\x0b\x0c\x0e-\x1f\x7f\x21\x23-\x5b\x5d-\x7e\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|\\[\x01-\x09\x0b\x0c\x0d-\x7f\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))*(([ \t]*\r\n)?[ \t]+)?")@(([a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.)+([a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.?$/i.test(t)) || (r = !0, l.parent().addClass("error")), c.val() || (r = !0, c.parent().addClass("error")), !r && ($.post(i, o.serialize(), function(e) {
            jQuery.parseJSON(e) ? o.append('<div class="crtFormResponce"><strong>Congratulation!</strong><br>Your email was sent successfully!</div>') : o.append('<div class="crtFormResponce"><strong>OOPS!</strong> Something went wrong.<br>Please try again.</div>')
        }), !1)
    })
});

// Fonction pour descendre automatiquement lors du chargement de la page si l'écran est <= 800px
window.addEventListener('DOMContentLoaded', function() {
    if (window.innerWidth <= 1000) { // Condition pour la largeur de l'écran
        window.scrollTo({
            top: 850, // Décalage en pixels (exemple : 850px vers le bas)
